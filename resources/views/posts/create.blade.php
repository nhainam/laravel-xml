                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('channel_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="channel_id"
                                            class="form-control form-control-alternative{{ $errors->has('channel_id') ? ' is-invalid' : '' }}"
                                            id="input-channel-id">
                                ...
                                <div class="form-group{{ $errors->has('published_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="published_date" id="input-published-date" required
                                           class="form-control form-control-alternative{{ $errors->has('published_date') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('Published') }}" value="{{ old('published_date') }}" />
                                ...
                                <div class="form-group{{ $errors->has('guid') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="guid" id="input-guid"
                                           ...
                                           placeholder="{{ __('Guid') }}" value="{{ old('guid') }}" />
                                ...
                                <div class="form-check{{ $errors->has('is_permalink') ? ' has-danger' : '' }}">
                                    <label class="form-check-label">
                                        <input name="is_permalink" class="form-check-input" type="checkbox" value="1">
                                        {{ __('Is permalink') }}
